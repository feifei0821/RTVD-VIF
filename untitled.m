...
%---------------------------------------------------------
img1 = imread('C:\Users\xue jiaoLi\Desktop\code\imgs\VIS_Kaptein_1123_Vis.bmp');%Provide input image path
img2 = cat(3,img1,img1,img1);
gfrgb = imfilter(img2, fspecial('gaussian', 3, 3), 'symmetric', 'conv');
%---------------------------------------------------------
